<div class="row">
	<div class="col-lg-12">
   		<h3 class="page-header"><i class="fa fa-navicon"></i> Data Panitia</h3>
	...
	<div class="col-lg-12">
   		<div class="panel panel-default">
   			<div class="panel-heading">
   				<div class="row">
   					<div class="col-md-12">
   						<a href="{{ URL::to('admin/panitia/tambah')}}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Panitia</a>
   					</div>
   				</div>
   			</div>
   			<div class="panel-body">
   		      <div class="table-responsive">
                  <table  cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped dataTable" id="panitia">
                      <thead>
                        <tr>
    ...
    <script type="text/javascript">
      ...
      $(function() {
          $("#panitia").dataTable({
           "processing":true,
           "serverSide": true,
           "ajax":"{{ URL::to('admin/panitia/listAjax') }}",
           "columnsDefs":[{
               "targets":"_all",
               "defaultContent":""
           }],
         ...
         $("#panitia").on('click','#del',function(event){
