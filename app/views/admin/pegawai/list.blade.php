<div class="row">
	<div class="col-lg-12">
   		<h3 class="page-header"><i class="fa fa-navicon"></i> Data Pegawai</h3>
	...
	<div class="col-lg-12">
   		<div class="panel panel-default">
   			<div class="panel-heading">
   				<div class="row">
   					<div class="col-md-12">
   						<a href="{{ URL::to('admin/pegawai/add')}}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
   					</div>
   				</div>
   			</div>
   			<div class="panel-body">
   		      <div class="table-responsive">
                  <table  cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped dataTable" id="pegawai">
                      <thead>
                        <tr>
   ...
   {{HTML::script('asset/themes/js/plugins/dataTables/jquery.dataTables.js')}}
    ...
    <script type="text/javascript">
      ...
      $(function() {
         ...
         $("#pegawai").on('click','#del',function(event){
