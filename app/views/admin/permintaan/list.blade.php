<div class="row">
   <div class="col-lg-12">
         <h3 class="page-header"><i class="fa fa-clipboard"></i> Daftar Permintaan Pengadaan</h3>
   </div>              
</div>
<div class="row">
   <div class="col-lg-12">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               <div class="table-responsive">
                  <table  cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped dataTable" id="permintaan" >
                      <thead>
                        <tr>
    ...
    <script type="text/javascript">
      ...
      $(function() {
          $("#permintaan").dataTable({
           "processing":true,
           "serverSide": true,
           "ajax":"{{ URL::to('admin/permintaanajax') }}",
           "columnsDefs":[{
               "targets":"_all",
               "defaultContent":""
           }],
